...
See also the [migration guide](/docs/usage/migration/) for background and verification steps.
...
5. CI/CD
   ...
   - Typical job order: pip install 'opentide==0.6.1' → opentide validate → validate query per enabled platform → opentide generate → opentide generate docs --output docs → deploy stages.
...
- [Migration guide](/docs/usage/migration/)
- [Repository setup](/docs/usage/repository-setup/)
- [CLI setup](/docs/cli/setup/)
