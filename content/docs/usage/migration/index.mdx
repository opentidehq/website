...
Optional MCP server setup: `opentide setup mcp --cursor --yes` (after `pip install 'opentide==0.6.1'`).
...
- [ ] `pip install 'opentide==0.6.1'` succeeds
