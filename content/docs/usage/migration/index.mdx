...
Optional MCP server setup: `opentide setup mcp --cursor --yes` (after `pip install 'opentide==0.6.0'`).
...
```yaml
- run: pip install 'opentide==0.6.0'
...
- [ ] `pip install 'opentide==0.6.0'` succeeds
