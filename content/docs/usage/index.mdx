...
<Cards>
  ...
  <Card title="0.5.0 release" href="/docs/usage/releases/" description="Current PyPI release — pin opentide==0.5.0 (threat impact and leverage are vocabulary lists, as threat::1.0 specifies)." />
</Cards>
...
| **Checking what shipped** | [Releases](/docs/usage/releases/) | [0.5.0 on PyPI](https://pypi.org/project/opentide/0.5.0/) |
