...
<Cards>
  ...
  <Card title="0.2.1 release" href="/docs/usage/releases/" description="Current PyPI release — pin opentide==0.2.1 (CIRCL Vulnerability-Lookup for CVE)." />
</Cards>
...
| **Checking what shipped** | [Releases](/docs/usage/releases/) | [0.2.1 on PyPI](https://pypi.org/project/opentide/0.2.1/) |
