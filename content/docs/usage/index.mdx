...
<Cards>
  ...
  <Card title="0.2.0 release" href="/docs/usage/releases/" description="Current PyPI release — pin opentide==0.2.0 (FieldInfo YAML templates)." />
</Cards>
...
| **Checking what shipped** | [Releases](/docs/usage/releases/) | [0.2.0 on PyPI](https://pypi.org/project/opentide/0.2.0/) |
