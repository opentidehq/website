...
<Cards>
  ...
  <Card title="0.6.0 release" href="/docs/usage/releases/" description="Current PyPI release — pin opentide==0.6.0 (workspace discovery, human output, and unfinished repositories)." />
</Cards>
...
| **Checking what shipped** | [Releases](/docs/usage/releases/) | [0.6.0 on PyPI](https://pypi.org/project/opentide/0.6.0/) |
