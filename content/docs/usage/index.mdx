...
<Cards>
  ...
  <Card title="0.3.0 release" href="/docs/usage/releases/" description="Current PyPI release — pin opentide==0.3.0 (maintenance: cryptography 50.x, typer 0.27)." />
</Cards>
...
| **Checking what shipped** | [Releases](/docs/usage/releases/) | [0.3.0 on PyPI](https://pypi.org/project/opentide/0.3.0/) |
