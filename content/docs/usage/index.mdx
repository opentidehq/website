...
<Cards>
  ...
  <Card title="0.6.1 release" href="/docs/usage/releases/" description="Current PyPI release — pin opentide==0.6.1 (CI deploy plans, setup path, and promotion flags)." />
</Cards>
...
| **Checking what shipped** | [Releases](/docs/usage/releases/) | [0.6.1 on PyPI](https://pypi.org/project/opentide/0.6.1/) |
