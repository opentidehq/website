...
<Cards>
  ...
  <Card title="0.6.3 release" href="/docs/usage/releases/" description="Current PyPI release — pin opentide==0.6.3 (remaining CI diff failures)." />
</Cards>
...
| **Checking what shipped** | [Releases](/docs/usage/releases/) | [0.6.3 on PyPI](https://pypi.org/project/opentide/0.6.3/) |
