...
<Cards>
  ...
  <Card title="0.1.6 release" href="/docs/usage/releases/" description="Current PyPI patch — pin opentide==0.1.6 (generate YAML dates and interactive setup)." />
</Cards>
...
| **Checking what shipped** | [Releases](/docs/usage/releases/) | [0.1.6 on PyPI](https://pypi.org/project/opentide/0.1.6/) |
