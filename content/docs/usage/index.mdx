...
<Cards>
  ...
  <Card title="0.4.0 release" href="/docs/usage/releases/" description="Current PyPI release — pin opentide==0.4.0 (first-user fixes: offline validate query, MCP contracts, setup CI templates)." />
</Cards>
...
| **Checking what shipped** | [Releases](/docs/usage/releases/) | [0.4.0 on PyPI](https://pypi.org/project/opentide/0.4.0/) |
