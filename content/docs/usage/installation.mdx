...
The latest release is **0.6.1** (23 September 2026). The first public release was **0.1.0** (9 September 2026). Notes: [Releases](/docs/usage/releases/).

```bash
pip install opentide              # latest on PyPI
pip install 'opentide==0.6.3'     # pin the current release
```
