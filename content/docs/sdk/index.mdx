...
| Page | Topic |
|------|-------|
| [Installation](/docs/sdk/installation/) | Extras and typing support |
| [Registry](/docs/sdk/registry/) | Lifecycle, accessors, lookup |
| [Validation](/docs/sdk/validation/) | `run_validation`, scopes, reports |
| [Documentation API](/docs/sdk/documentation/) | Render and write markdown pages |
| [Models](/docs/sdk/models/) | Pydantic object types |
| [Platforms](/docs/sdk/platforms/) | Deployers, validators, plugins |
...
Set `dry_run=False` and provide [credentials](/docs/usage/configuration/#credentials) for a real deploy. See [Validation](/docs/sdk/validation/) and [Models → delegation](/docs/sdk/models/#delegation-methods).

## Choosing between SDK, CLI, and MCP

Use the SDK to embed the engine in Python; use the [CLI](/docs/cli/) for humans and pipelines; use [MCP](/docs/mcp/) for agents. See [Choosing an interface](/docs/usage/choosing-an-interface/).
