...
See [Platforms](/docs/sdk/platforms/).
...
OpenTide.root    # detection workspace root Path (not necessarily the git top level)
```

## MCP parity

MCP resources expose the same index and model dumps as JSON — see [MCP resources](/docs/mcp/resources/).
