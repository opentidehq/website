...
|--------|--------|---------|------|
| **Threat** | `threat::1.0` | What do we defend against? | [threat-1.0](/docs/specifications/specs/objects/threat-1.0/) |
| **Objective** | `objective::1.0` | What are we trying to detect? | [objective-1.0](/docs/specifications/specs/objects/objective-1.0/) |
| **Rule** | `rule::1.0` | How do we detect it, on which platform? | [rule-1.0](/docs/specifications/specs/objects/rule-1.0/) |
...
- `metadata.schema` (e.g. `rule::1.0`) — the **structural revision**, selecting the validation model. See [versioning](/docs/specifications/specs/versioning/).
...
1. **[Conformance](/docs/specifications/conformance/)** — how to read the normative keywords.
2. **[Metadata](/docs/specifications/specs/metadata/)** — the block every object shares.
3. **The object spec** you care about — [threat](/docs/specifications/specs/objects/threat-1.0/), [objective](/docs/specifications/specs/objects/objective-1.0/), or [rule](/docs/specifications/specs/objects/rule-1.0/).
4. **[Validation](/docs/specifications/specs/validation/)** — what the engine checks and when.

## Full index

The [spec index](/docs/specifications/SPECS/) lists every active spec, its version, and status. Core infrastructure specs cover [workspace layout](/docs/specifications/specs/workspace/), [configuration](/docs/specifications/specs/configuration/), [deployment](/docs/specifications/specs/deployment/), [platforms](/docs/specifications/specs/platforms/), [metaschema keywords](/docs/specifications/specs/metaschema-keywords/), and [vocabularies](/docs/specifications/specs/vocabularies/format/).

Changes follow the process in [Governance](/docs/specifications/GOVERNANCE/).
