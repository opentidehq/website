...
- [rule-1.0.md](/docs/specifications/specs/objects/rule-1.0/) — `configurations` blocks
- [configuration.md](/docs/specifications/specs/configuration/) — platform TOML merge
- [deployment.md](/docs/specifications/specs/deployment/) — per-platform `status`
- [validation.md](/docs/specifications/specs/validation/) — `validate query` command
- [metaschema-keywords.md](/docs/specifications/specs/metaschema-keywords/) — `tide.config.systems::enabled`, `recomposition`

## Defaults & overrides

All bundled platforms default to `enabled = false`. Clients enable platforms in `.opentide/configurations/platforms/`. See [configuration.md](/docs/specifications/specs/configuration/).
