...
- [rule-1.0.md](/docs/specifications/specs/objects/rule-1.0/) — `status` field on rules and platform blocks
- [configuration.md](/docs/specifications/specs/configuration/) — override mechanism
- [platforms.md](/docs/specifications/specs/platforms/) — per-platform deployment
- [metaschema-keywords.md](/docs/specifications/specs/metaschema-keywords/) — `tide.config.statuses` keyword
