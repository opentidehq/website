...
3. Resolve the contract via per-key lifecycle rules in [vocabularies/format.md](/docs/specifications/specs/vocabularies/format/) (cumulative minor filter + `removed`).
...
- [vocabularies/format.md](/docs/specifications/specs/vocabularies/format/) — vocabulary file format and per-key lifecycle
- [schemas/pins/](https://github.com/OpenTideHQ/specifications/blob/main/schemas/pins/) — per-schema vocabulary pin manifests
...
- [configuration.md](/docs/specifications/specs/configuration/) — config sources for `tide.config.*`
- [deployment.md](/docs/specifications/specs/deployment/) — statuses for `tide.config.statuses`
- [platforms.md](/docs/specifications/specs/platforms/) — `recomposition` and platform schemas
- [validation.md](/docs/specifications/specs/validation/) — metaschema-driven vocabulary and deprecation walks

## Defaults & overrides

Configuration keywords reflect merged TOML at `opentide generate schemas` time. Client overrides affect generated enums. See [configuration.md](/docs/specifications/specs/configuration/).
...
Threat schema `threat::1.0` pins `threat.killchain` to `killchain::1.0` via [schemas/pins/threat.toml](https://github.com/OpenTideHQ/specifications/blob/main/schemas/pins/threat.toml). A later `threat::2.1` revision may pin `killchain::1.1` while other pins remain at `::1.0`.
