...
- Vocabulary files MUST NOT declare a top-level `version` property; versioning is per `[[keys]]` entry (see [RFC 0003](/docs/specifications/rfcs/0003-per-key-vocabulary-versioning/)).
...
Object schema revisions pin explicit contracts via [schemas/pins/](https://github.com/OpenTideHQ/specifications/blob/main/schemas/pins/) manifests (see [RFC 0003](/docs/specifications/rfcs/0003-per-key-vocabulary-versioning/)).
...
- [RFC 0003](/docs/specifications/rfcs/0003-per-key-vocabulary-versioning/) — per-key versioning and schema pins
...
| Version | Date | Notes |
|---------|------|-------|
| 1.1 | 2026-06-26 | Per-key `version`/`removed`; no top-level file version ([RFC 0003](/docs/specifications/rfcs/0003-per-key-vocabulary-versioning/)) |
