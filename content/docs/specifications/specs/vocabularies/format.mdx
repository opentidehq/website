...
- Vocabulary files MUST NOT declare a top-level `version` property; versioning is per `[[keys]]` entry (see [RFC 0003](https://github.com/OpenTideHQ/specifications/blob/main/rfcs/0003-per-key-vocabulary-versioning.md)).
...
Object schema revisions pin explicit contracts via [schemas/pins/](https://github.com/OpenTideHQ/specifications/blob/main/schemas/pins/) manifests (see [RFC 0003](https://github.com/OpenTideHQ/specifications/blob/main/rfcs/0003-per-key-vocabulary-versioning.md)).
...
- [catalog.md](/docs/specifications/specs/vocabularies/catalog/) — index of bundled vocabularies
- [metaschema-keywords.md](/docs/specifications/specs/metaschema-keywords/) — `tide.vocab` keyword resolution
- [RFC 0003](https://github.com/OpenTideHQ/specifications/blob/main/rfcs/0003-per-key-vocabulary-versioning.md) — per-key versioning and schema pins
- [configuration.md](/docs/specifications/specs/configuration/) — `schema.toml` vocabulary extensions
- [validation.md](/docs/specifications/specs/validation/) — vocabulary conformance checks
...
| Version | Date | Notes |
|---------|------|-------|
| 1.1 | 2026-06-26 | Per-key `version`/`removed`; no top-level file version ([RFC 0003](https://github.com/OpenTideHQ/specifications/blob/main/rfcs/0003-per-key-vocabulary-versioning.md)) |
