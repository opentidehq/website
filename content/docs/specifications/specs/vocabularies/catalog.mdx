...
- Each entry MUST validate per [format.md](/docs/specifications/specs/vocabularies/format/).
...
- [format.md](/docs/specifications/specs/vocabularies/format/) — TOML structure and sync interface
- Object specs — reference vocabularies by field name
- [metaschema-keywords.md](/docs/specifications/specs/metaschema-keywords/) — `tide.vocab` binding

## Defaults & overrides

Vocabularies are not client-overridable. See [configuration.md](/docs/specifications/specs/configuration/).
