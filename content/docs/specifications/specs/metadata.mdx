...
- [versioning.md](/docs/specifications/specs/versioning/) — `metadata.schema` and `metadata.version` semantics
- [specs/vocabularies/catalog.md](/docs/specifications/specs/vocabularies/catalog/) — `tlp` vocabulary
