...
- [metadata.md](/docs/specifications/specs/metadata/) — shared metadata
- [threat-1.0.md](/docs/specifications/specs/objects/threat-1.0/) — referenced by `objective.threats`
- [rule-1.0.md](/docs/specifications/specs/objects/rule-1.0/) — rules reference objectives via `detection_model` (objective UUID)
- Vocabularies: `detection.composition`, `detection.types`, `detection.methodology`, `signal.entities`, `severity`, `datasources`, `efforts`

## Defaults & overrides

No object-level configuration overrides. See [configuration.md](/docs/specifications/specs/configuration/).
