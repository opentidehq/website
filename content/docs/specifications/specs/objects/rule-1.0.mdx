...
- `status` MUST be a valid deployment status from [deployment.md](/docs/specifications/specs/deployment/) (default: `STAGING`).
...
See [platforms.md](/docs/specifications/specs/platforms/) for per-platform required fields and capabilities.

## Relationships

- [metadata.md](/docs/specifications/specs/metadata/) — identity and schema routing
- [objective-1.0.md](/docs/specifications/specs/objects/objective-1.0/) — linked via `detection_model`
- [deployment.md](/docs/specifications/specs/deployment/) — `status` lifecycle and promotion
- [platforms.md](/docs/specifications/specs/platforms/) — platform blocks and deploy/validate capabilities
- [validation.md](/docs/specifications/specs/validation/) — schema, vocabulary, and query validation
...
Vocabulary files are canonical in `vocabularies/` — not overridable. See [configuration.md](/docs/specifications/specs/configuration/).
