...
- [workspace.md](/docs/specifications/specs/workspace/) — default paths from `paths.toml`
- [deployment.md](/docs/specifications/specs/deployment/) — `deployment.toml` semantics
- [specs/vocabularies/format.md](/docs/specifications/specs/vocabularies/format/) — vocabulary extension via `schema.toml`
- [platforms.md](/docs/specifications/specs/platforms/) — platform TOML under `platforms/`
