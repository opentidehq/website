...
Layout migration for detection repositories that still use CoreTide directory names. This does **not** replace a CoreTide git submodule or Orchestration scripts — see the [migration guide](/docs/usage/migration/) for that.
