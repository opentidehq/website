...
A real deploy reports created/updated/skipped counts. With `--json`, the payload includes `"ok"`, status, and plan details. Non-zero [exit codes](/docs/cli/exit-codes/) signal deployment errors.
