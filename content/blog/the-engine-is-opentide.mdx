...
description: pip install opentide==0.1.0. First public beta. We are archiving the old engine, keeping pinned checkouts alive, and taking four weeks of bug reports.
...
The engine used to ship as a git submodule. It is a PyPI package now — `pip install opentide==0.1.0` — CLI, MCP, and SDK on the same object graph. That is the default for new work. Notes: [0.1.0](/docs/usage/releases/).
